...
const framing:Record<string,{zoom:number;position:string}>={
  "Allen's Hummingbird":{zoom:1.14,position:"42% 48%"},"American Robin":{zoom:1.28,position:"50% 50%"},"Anna's Hummingbird":{zoom:1.22,position:"47% 47%"},"Barn Swallow":{zoom:1.34,position:"50% 52%"},"Bewick's Wren":{zoom:1.28,position:"52% 52%"},"Black-capped Chickadee":{zoom:1.26,position:"52% 50%"},"Black Phoebe":{zoom:1.25,position:"54% 50%"},"Blyth's Leaf Warbler":{zoom:1.38,position:"46% 52%"},"Dark-eyed Junco":{zoom:1.30,position:"55% 50%"},"Eurasian Tree Sparrow":{zoom:1.26,position:"55% 52%"},"House Finch":{zoom:1.30,position:"55% 52%"},"House Sparrow":{zoom:1.28,position:"55% 52%"},"Lesser Goldfinch":{zoom:1.28,position:"56% 51%"},"Little Grebe":{zoom:1.38,position:"62% 52%"},"Orange-crowned Warbler":{zoom:1.36,position:"48% 54%"},"Pacific Wren":{zoom:1.28,position:"52% 52%"},"Purple Finch":{zoom:1.30,position:"53% 53%"},"Red-masked Parakeet":{zoom:1.25,position:"55% 50%"},"Red-shouldered Hawk":{zoom:1.27,position:"52% 52%"},"Red-whiskered Bulbul":{zoom:1.28,position:"52% 52%"},"Ring-billed Gull":{zoom:1.32,position:"58% 52%"},"Song Sparrow":{zoom:1.27,position:"54% 52%"},"Spotted Towhee":{zoom:1.27,position:"55% 52%"},"Steller's Jay":{zoom:1.25,position:"50% 53%"},"Swinhoe's White-eye":{zoom:1.34,position:"52% 52%"},"Western Bluebird":{zoom:1.30,position:"54% 52%"},"White-crowned Sparrow":{zoom:1.28,position:"52% 52%"},"Wilson's Warbler":{zoom:1.30,position:"54% 52%"}
};
