...
export default function AviaryJournal(){
  ...
  return <main className="journal" id="top">
    ...
    <header className="jhero"><div className="heroCopy"><h1>Birds I’ve met<br/><em>along the way.</em></h1><p className="lede">A living field journal grown from two years of listening, wandering, and paying attention.</p><a className="enter" href="#field-guide">Field guide <span>↓</span></a></div><div className="heroHabitat" aria-hidden="true"><div className="orb"/><div className="flightBird bigBird"><i/></div><div className="flightBird smallBird"><i/></div><div className="reed r1"/><div className="reed r2"/><div className="reed r3"/></div><div className="stats"><span><b>51</b><small>encounters</small></span><span><b>28</b><small>species</small></span><span><b>6</b><small>regions</small></span><span><b>2024—26</b><small>years</small></span></div></header>
    ...
    <footer><a href="#top" className="jbrand"><i>✦</i> SALENE'S AVIARY</a><p>From my Merlin life list · Updated August 18, 2026</p></footer>
